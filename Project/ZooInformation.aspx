            ...
            <table class="auto-style10">
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:Panel ID="pnlOpeningHours" runat="server" BorderColor="#D6D6D6" BorderStyle="Solid" BorderWidth="2px" Height="299px">
                            ...
                            <br />
                            <br />
                            <asp:Label ID="Label26" runat="server" Text="Monday - Thursday                                                                                                                            8:00 - 17:00"></asp:Label>
                            <br />
                            <br />
                            <asp:Label ID="Label27" runat="server" Text="Friday - Sunday                                                                                                             8:00 - 18:30"></asp:Label>
                            <br />
                            <br />
                            <asp:Label ID="Label28" runat="server" Text="Public Holiday                                                                                                                                                               8:00 - 15:00"></asp:Label>
                            <br />
                            <br />
                        </asp:Panel>
                    </td>
                ...
                <tr>
                    ...
                    <td class="auto-style23" colspan="2">
                        <asp:Panel ID="pnlFaq" runat="server" BorderColor="#D6D6D6" BorderStyle="Solid" BorderWidth="2px" Height="547px">
                            <table class="auto-style12">
                                <tr>
                                    <td>
                                        <asp:LinkButton ID="btnFaq1" runat="server" OnClick="btnFaq1_Click">What should I bring for my visit?</asp:LinkButton>
                                        <br />
                                        <asp:Panel ID="pnlFAQ1" runat="server" Height="63px" Visible="False">
                                            <asp:Label ID="lblFaq1" runat="server" Text="Comfortable walking shoes, sunscreen, a hat, and a water bottle. Photography is welcome in all zones. Tripods require a special permit."></asp:Label>
                                        </asp:Panel>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style21">
                                        ...
                                        <br />
                                        <asp:Panel ID="pnlFAQ2" runat="server" Height="44px" Visible="False">
                                ...
                                <tr>
                                    <td class="auto-style26">
                                        ...
                                        <br />
                                        <asp:Panel ID="pnlFAQ3" runat="server" Height="51px" Visible="False">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <asp:Panel ID="pnlFAQ4" runat="server" Height="44px" Visible="False">
                                ...
                                <tr>
                                    <td class="auto-style11">
                                        ...
                                        <br />
                                        <asp:Panel ID="pnlFAQ5" runat="server" Height="51px" Visible="False">
