...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="auto-style9" rowspan="2">
                        <asp:Panel ID="Panel3" runat="server" GroupingText="Edit Profile" Height="644px" BorderStyle="None">
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblName" runat="server" Text="Full Name"></asp:Label>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtName" runat="server" BackColor="White" Height="19px" Width="252px" BorderStyle="Solid"></asp:TextBox>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtEmail" ErrorMessage="Please Enter Full Name" Font-Size="Small" ForeColor="Red" ValidationGroup="btnUpdateProfile"></asp:RequiredFieldValidator>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblSurname" runat="server" Text="Surname"></asp:Label>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtSurname" runat="server" BackColor="White" Height="21px" Width="252px" BorderStyle="Solid"></asp:TextBox>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtEmail" ErrorMessage="Please Enter Surname" Font-Size="Small" ForeColor="Red" ValidationGroup="btnUpdateProfile"></asp:RequiredFieldValidator>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblEmail" runat="server" Text="Email Address"></asp:Label>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtEmail" runat="server" Height="20px" Width="249px" TextMode="Email" BackColor="White" BorderStyle="Solid"></asp:TextBox>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEmail" ErrorMessage="Please Enter Email Address" Font-Size="Small" ForeColor="Red" ValidationGroup="btnUpdateProfile"></asp:RequiredFieldValidator>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            &nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:DropDownList ID="ddrlCountry" runat="server" Height="26px" Width="252px" OnSelectedIndexChanged="ddrlCountry_SelectedIndexChanged">
                                <asp:ListItem Value="0">Select Country</asp:ListItem>
                            </asp:DropDownList>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddrlCountry" ErrorMessage="Please Select Country" Font-Size="Small" ForeColor="Red" InitialValue="0" ValidationGroup="btnUpdateProfile"></asp:RequiredFieldValidator>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Label ID="lblPhoneNumber" runat="server" Text="Phone Number"></asp:Label>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtNumber" runat="server" Height="27px" TextMode="Phone" Width="249px" BorderStyle="Solid"></asp:TextBox>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtNumber" ErrorMessage="Please enter phone number" Font-Size="Small" ForeColor="Red" ValidationGroup="btnUpdateProfile"></asp:RequiredFieldValidator>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnUpdateProfile" runat="server" BackColor="#339933" BorderColor="#009933" BorderStyle="Groove" ForeColor="White" Height="37px" Text="Save Changes" Width="173px" OnClick="btnUpdateProfile_Click" ValidationGroup="btnUpdateProfile" />
                        </asp:Panel>
                    </td>
                    <td class="auto-style10" rowspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Panel runat="server" GroupingText="Delete Account" Height="365px" ID="PnlDelete">
                            ...
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtEmailDelete" runat="server" Width="221px" TextMode="Email" BorderStyle="Solid"></asp:TextBox>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" Width="221px" BorderStyle="Solid"></asp:TextBox>
                            <br />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
