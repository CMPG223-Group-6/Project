            ...
            <table style="width:100%;">
                ...
                <tr>
                    ...
                    <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ForeColor="Red" ValidationGroup="UpdateEvent" ControlToValidate="ddlCategory"></asp:RequiredFieldValidator>
                            <br />
