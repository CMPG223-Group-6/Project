                ...
                <tr>
                    ...
                    <td class="auto-style9">
                        <asp:Panel ID="Panel1" runat="server" Height="458px" Width="566px">
                            ...
                            &nbsp;&nbsp;
                            <asp:DropDownList ID="ddrlEventID" runat="server" AutoPostBack="True" Width="224px">
...
&nbsp;<br />
                            ...
                            &nbsp;&nbsp;
                            <asp:TextBox ID="txtDate" runat="server" AutoPostBack="True" TextMode="Date" Width="220px"></asp:TextBox>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            &nbsp;&nbsp;
                            <asp:TextBox ID="txtNumberTickets" runat="server" AutoPostBack="True" Height="23px" Width="133px"></asp:TextBox>
                            <br />
